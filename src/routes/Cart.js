...
export default function Cart(props) {
  ...
  const selectedItemsLength = Object.entries(selectedItems).filter(
    ([key, value]) => value
  ).length;
    ...
    <Box position="relative" width="100%" py={1}>
      ...
      >
        ...
        <Box>
          ...
          <IconButton
            disabled={!selectMode || selectedItemsLength < 1}
      ...
      >
        ...
        <StyledTypography variant="subtitle1" sx={{ mt: 1 }}>
          ...
          <StyledSpan>
            {" "}
            {promotion
              ? calculatePrice(promotion, totalPrice)
              : totalPrice} MMK{" "}
          </StyledSpan>
        </StyledTypography>
      </Box>
