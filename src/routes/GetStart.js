      ...
      <Grid container sx={{ mt: 2, mx: { xs: 0, md: 1 } }}>
        <Grid item xs={12} sx={{ display: "flex", alignItems: "flex-end" }}>
          ...
          <Typography variant="subtitle1">
            (<span style={{ color: "#ff4081" }}>AKK</span>{" "}
            <span style={{ color: "#90caf9" }}>Videos Shop</span>)
          </Typography>
        </Grid>
        <Grid item xs={12} md={7}>
          ...
          >
            is a place from where you can collect your preferable Movies or Tv
            Series and watch them offline by spending starting only from 300 Ks!
          </Typography>
        </Grid>
        <Grid item xs={12}>
          <Button
