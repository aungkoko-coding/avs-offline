            ...
            <List>
                ...
                <ListItem>
                    <ListItemText
                        ...
                        secondary={
                            <React.Fragment>
                                Go to the page that show your added items.
                                (To reach that page, click <ShoppingCartIcon color='primary' fontSize='small' /> icon which is at top-right corner of app screen)
                            </React.Fragment>
                        }
                    />
                </ListItem>
            ...
            <List>
                <ListItem>
                    <ListItemText
                        ...
                        secondary={
                            <React.Fragment>
                                First, you will need to enable 'SELECT' mode! Click <SelectIcon fontSize='small' /> or <SelectAllIcon fontSize='small' /> 
                ...
                <ListItem>
                    <ListItemText
                        ...
                        secondary={
                            <React.Fragment>
                                Then you can delete by clicking <DeleteIcon color='error' fontSize='small' sx={{paddingTop: '5px'}} /> icon. That is it!
                            </React.Fragment>
                        }
                    />
                </ListItem>
